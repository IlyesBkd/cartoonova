...
export const confirmationEmail: Record<Lang, {
 ...
 fr: {
 subject: "Commande confirmée - on commence votre portrait!",
 ...
 option: "Option",
 total: "Total",
 artistsWorking: "On se met au travail!",
 ...
 option: "Option",
 total: "Total",
 artistsWorking: "We're getting to work!",
 ...
 es: {
 subject: "Pedido confirmado - ¡empezamos tu retrato!",
 ...
 option: "Opción",
 total: "Total",
 artistsWorking: "¡Nos ponemos manos a la obra!",
 ...
 de: {
 subject: "Bestellung bestätigt - wir legen los!",
 ...
 option: "Option",
 total: "Gesamt",
 artistsWorking: "Wir machen uns an die Arbeit!",
 ...
 it: {
 subject: "Ordine confermato - iniziamo il tuo ritratto!",
 ...
 option: "Opzione",
 total: "Totale",
 artistsWorking: "Ci mettiamo al lavoro!",
 ...
 nl: {
  subject: "Bestelling bevestigd – we gaan aan de slag!",
  ...
  option: "Optie",
  total: "Totaal",
  artistsWorking: "We gaan meteen aan de slag!",
 ...
 pl: {
  subject: "Zamówienie potwierdzone – zaczynamy!",
  ...
  option: "Opcja",
  total: "Razem",
  artistsWorking: "Bierzemy się do pracy!",
 ...
 sv: {
  subject: "Beställning bekräftad – vi sätter i gång!",
  ...
  option: "Alternativ",
  total: "Totalt",
  artistsWorking: "Vi sätter i gång!",
 ...
 da: {
  subject: "Bestilling bekræftet – vi går i gang!",
 ...
 pt: {
  subject: "Encomenda confirmada – vamos já começar!",
  ...
  option: "Opção",
  total: "Total",
  artistsWorking: "Vamos já começar!",
...
export const finalImageEmail: Record<Lang, {
 ...
 fr: {
  ...
  ready: (ref) => `Votre portrait est terminé (commande <strong>#${ref}</strong>). Le voici — on a hâte de savoir ce que vous en pensez:`,
  question: "Alors, qu'en pensez-vous?",
  download: "Télécharger mon portrait",
  feedback: "Un détail à ajuster? Une couleur, un sourire, un arrière-plan? N'hésitez surtout pas: répondez simplement à cet e-mail et on s'en occupe. Les retouches sont illimitées et gratuites — on ne s'arrête que quand le portrait vous plaît vraiment.",
 ...
 en: {
  ...
  ready: (ref) => `Your portrait is ready (order <strong>#${ref}</strong>). Here it is — we can't wait to hear what you think:`,
  question: "So, what do you think?",
  download: "Download my portrait",
  feedback: "Anything you'd like tweaked? A colour, a smile, the background? Please don't hesitate: just reply to this email and we'll take care of it. Revisions are unlimited and free — we don't stop until you genuinely love it.",
 ...
 es: {
  ...
  ready: (ref) => `Tu retrato está listo (pedido <strong>#${ref}</strong>). Aquí lo tienes: nos encantará saber qué te parece.`,
  question: "Y bien, ¿qué te parece?",
  download: "Descargar mi retrato",
  feedback: "¿Hay algún detalle que quieras cambiar? ¿Un color, una sonrisa, el fondo? No lo dudes ni un momento: responde a este email y nos encargamos. Los retoques son ilimitados y gratuitos — no paramos hasta que te enamore.",
 ...
 de: {
  ...
  ready: (ref) => `Ihr Porträt ist fertig (Bestellung <strong>#${ref}</strong>). Hier ist es — wir sind gespannt, wie es Ihnen gefällt:`,
  question: "Und, wie gefällt es Ihnen?",
  download: "Mein Porträt herunterladen",
  feedback: "Möchten Sie noch etwas ändern? Eine Farbe, ein Lächeln, den Hintergrund? Zögern Sie bitte nicht: Antworten Sie einfach auf diese E-Mail, und wir kümmern uns darum. Änderungen sind unbegrenzt und kostenlos — wir hören erst auf, wenn Ihnen das Porträt wirklich gefällt.",
 ...
 it: {
  ...
  ready: (ref) => `Il tuo ritratto è pronto (ordine <strong>#${ref}</strong>). Eccolo — non vediamo l'ora di sapere cosa ne pensi:`,
  question: "Allora, che ne pensi?",
  download: "Scarica il mio ritratto",
  feedback: "C'è qualche dettaglio da sistemare? Un colore, un sorriso, lo sfondo? Non esitare proprio: rispondi a questa email e ci pensiamo noi. Le modifiche sono illimitate e gratuite — non ci fermiamo finché il ritratto non ti piace davvero.",
 ...
 nl: {
  ...
  greeting: (name) => (name ? `Hallo ${name},` : "Hallo,"),
  ready: (ref) => `Je portret is klaar (bestelling <strong>#${ref}</strong>). Hier is het — we zijn benieuwd wat je ervan vindt:`,
  question: "En, wat vind je ervan?",
  download: "Mijn portret downloaden",
  feedback: "Wil je nog iets aangepast zien? Een kleur, een glimlach, de achtergrond? Aarzel vooral niet: beantwoord gewoon deze mail en we gaan ermee aan de slag. Aanpassingen zijn onbeperkt en gratis — we stoppen pas als het portret je echt bevalt.",
 ...
 pl: {
  ...
  ready: (ref) => `Twój portret jest gotowy (zamówienie <strong>#${ref}</strong>). Oto on — nie możemy się doczekać, co o nim powiesz:`,
  question: "I jak, podoba się?",
  download: "Pobierz mój portret",
  feedback: "Chcesz coś poprawić? Kolor, uśmiech, tło? Naprawdę nie krępuj się: wystarczy odpisać na tego maila, a my się tym zajmiemy. Poprawki są nieograniczone i bezpłatne — nie przestajemy, dopóki portret naprawdę Ci się nie spodoba.",
 ...
 sv: {
  ...
  ready: (ref) => `Ditt porträtt är klart (order <strong>#${ref}</strong>). Här är det — vi är nyfikna på vad du tycker:`,
  question: "Vad säger du om det?",
  download: "Ladda ner mitt porträtt",
  feedback: "Är det något du vill ändra? En färg, ett leende, bakgrunden? Tveka absolut inte: svara bara på det här mejlet, så fixar vi det. Ändringar är obegränsade och kostnadsfria — vi slutar inte förrän du verkligen gillar porträttet.",
 ...
 da: {
  ...
  greeting: (name) => (name ? `Hej ${name},` : "Hej,"),
  ready: (ref) => `Dit portræt er klar (ordre <strong>#${ref}</strong>). Her er det — vi er spændte på at høre, hvad du synes:`,
  question: "Hvad synes du om det?",
  download: "Hent mit portræt",
  feedback: "Er der noget, du gerne vil have rettet? En farve, et smil, baggrunden? Tøv endelig ikke: svar bare på denne mail, så klarer vi det. Rettelser er ubegrænsede og gratis — vi stopper først, når du er rigtig glad for portrættet.",
 ...
 pt: {
  ...
  ready: (ref) => `O teu retrato está pronto (encomenda <strong>#${ref}</strong>). Aqui está — estamos ansiosos por saber o que achas:`,
  question: "Então, o que achas?",
  download: "Transferir o meu retrato",
  feedback: "Há algum detalhe que queiras ajustar? Uma cor, um sorriso, o fundo? Não hesites mesmo: basta responderes a este email e tratamos disso. Os retoques são ilimitados e gratuitos — só paramos quando o retrato te agradar mesmo.",
...
export const posterConfirmationEmail: Record<Lang, {
 ...
 greeting: (name) =>name? `Bonjour ${name},`: "Bonjour,",
 intro: (ref) =>`Votre portrait de la commande <strong>#${ref}</strong> est prêt à partir en impression. Vous trouverez la photo finale ci-dessous et en pièce jointe de cet email.`,
 ...
 reassurance: "Une fois votre confirmation reçue, nous lançons l'impression et l'expédition de votre portrait.",
 thanks: "Merci pour votre confiance! ",
 team: "L'équipe Cartoonova",
 },
 en: {
 ...
 intro: (ref) =>`Your portrait for order <strong>#${ref}</strong> is ready to go to print. You'll find the final photo below and attached to this email.`,
 ...
 reassurance: "Once we receive your confirmation, we'll start printing and shipping your portrait.",
 thanks: "Thank you for your trust! ",
 team: "The Cartoonova Team",
 },
 es: {
 ...
 greeting: (name) =>name? `Hola ${name},`: "Hola,",
 intro: (ref) =>`Tu retrato del pedido <strong>#${ref}</strong> está listo para imprimirse. Encontrarás la foto final debajo y adjunta a este correo.`,
 ...
 reassurance: "En cuanto recibamos tu confirmación, empezaremos a imprimir y enviar tu retrato.",
 thanks: "¡Gracias por tu confianza! ",
 team: "El equipo Cartoonova",
 },
 de: {
 ...
 greeting: (name) =>name? `Hallo ${name},`: "Hallo,",
 intro: (ref) =>`Ihr Porträt zur Bestellung <strong>#${ref}</strong> ist druckfertig. Das finale Bild finden Sie unten und im Anhang dieser E-Mail.`,
 ...
 reassurance: "Sobald Ihre Bestätigung eingeht, starten wir den Druck und Versand Ihres Porträts.",
 thanks: "Vielen Dank für Ihr Vertrauen! ",
 team: "Das Cartoonova-Team",
 },
 it: {
 ...
 greeting: (name) =>name? `Ciao ${name},`: "Ciao,",
 intro: (ref) =>`Il tuo ritratto dell'ordine <strong>#${ref}</strong> è pronto per la stampa. Trovi la foto finale qui sotto e in allegato a questa email.`,
 ...
 reassurance: "Non appena riceviamo la tua conferma, avviamo la stampa e la spedizione del tuo ritratto.",
 thanks: "Grazie per la tua fiducia! ",
 team: "Il team Cartoonova",
 },
 nl: {
  ...
  greeting: (name) => (name ? `Hallo ${name},` : "Hallo,"),
  intro: (ref) => `Je portret voor bestelling <strong>#${ref}</strong> is klaar om gedrukt te worden. Hieronder en in de bijlage vind je de definitieve foto.`,
  ...
  reassurance: "Zodra we je bevestiging binnen hebben, gaan we drukken en versturen we je portret.",
  thanks: "Bedankt voor je vertrouwen! ",
  team: "Het Cartoonova-team",
 },
 pl: {
  ...
  greeting: (name) => (name ? `Cześć ${name},` : "Cześć,"),
  intro: (ref) => `Portret do zamówienia <strong>#${ref}</strong> jest gotowy do druku. Poniżej i w załączniku znajdziesz ostateczną wersję.`,
  ...
  reassurance: "Gdy tylko dostaniemy potwierdzenie, drukujemy i wysyłamy portret.",
  thanks: "Dziękujemy za zaufanie! ",
  team: "Zespół Cartoonova",
 },
 sv: {
  ...
  greeting: (name) => (name ? `Hej ${name},` : "Hej,"),
  intro: (ref) => `Porträttet till beställning <strong>#${ref}</strong> är redo att tryckas. Nedan och i bilagan hittar du den färdiga bilden.`,
  ...
  reassurance: "Så fort vi fått ditt godkännande trycker vi och skickar porträttet.",
  thanks: "Tack för förtroendet! ",
  team: "Cartoonova-teamet",
 },
 da: {
  ...
  greeting: (name) => (name ? `Hej ${name},` : "Hej,"),
  intro: (ref) => `Portrættet til bestilling <strong>#${ref}</strong> er klar til tryk. Herunder og i vedhæftningen finder du det færdige billede.`,
  ...
  reassurance: "Så snart vi har din godkendelse, trykker vi og sender portrættet.",
  thanks: "Tak for tilliden! ",
  team: "Cartoonova-teamet",
 },
 pt: {
  ...
  greeting: (name) => (name ? `Olá ${name},` : "Olá,"),
  intro: (ref) => `O retrato da encomenda <strong>#${ref}</strong> está pronto para ir para impressão. Em baixo e em anexo encontras a imagem final.`,
  ...
  reassurance: "Assim que recebermos a tua confirmação, imprimimos e enviamos o retrato.",
  thanks: "Obrigado pela confiança! ",
  team: "A equipa Cartoonova",
 }
};
...
export const posterConfirmationPage: Record<Lang, {
 ...
 description: "Merci de vérifier attentivement le visuel ci-dessous avant que nous lancions l'impression de votre portrait.",
 ...
 confirmedBody: "Votre portrait part en impression puis en expédition. Vous recevrez un email dès son envoi.",
 ...
 description: "Please review the artwork below carefully before we send your portrait to print.",
 confirmButton: "I confirm, print and ship it",
 changesButton: "I'd like a change",
 confirmedTitle: "Thanks, you're all set!",
 confirmedBody: "Your portrait is going to print and will ship soon. You'll get an email as soon as it's on its way.",
 ...
 description: "Revisa con atención el diseño de abajo antes de que enviemos tu retrato a imprimir.",
 confirmButton: "Confirmo, imprímanlo y envíenlo",
 changesButton: "Quiero un cambio",
 confirmedTitle: "¡Gracias, todo listo!",
 confirmedBody: "Tu retrato pasa a imprenta y se enviará pronto. Te avisaremos por email en cuanto salga.",
 ...
 description: "Bitte prüfen Sie das Motiv unten sorgfältig, bevor wir Ihr Porträt in den Druck geben.",
 ...
 confirmedBody: "Ihr Porträt geht in den Druck und wird bald versendet. Sie erhalten eine E-Mail, sobald es unterwegs ist.",
 ...
 description: "Controlla attentamente la grafica qui sotto prima che mandiamo il tuo ritratto in stampa.",
 confirmButton: "Confermo, stampatelo e speditelo",
 changesButton: "Vorrei una modifica",
 confirmedTitle: "Grazie, tutto confermato!",
 confirmedBody: "Il tuo ritratto va in stampa e verrà spedito a breve. Ti avviseremo via email non appena partirà.",
 ...
 nl: {
  ...
  description: "Bekijk het ontwerp hieronder goed voordat we je portret naar de drukker sturen.",
  confirmButton: "Akkoord, drukken en versturen",
  changesButton: "Ik wil iets aangepast",
  confirmedTitle: "Bedankt, alles staat klaar!",
  confirmedBody: "Je portret gaat naar de drukker en wordt binnenkort verstuurd. Je krijgt een mail zodra het onderweg is.",
 ...
 pl: {
  ...
  description: "Obejrzyj dokładnie grafikę poniżej, zanim wyślemy portret do druku.",
  confirmButton: "Potwierdzam, drukujcie i wysyłajcie",
  changesButton: "Chcę zmianę",
  confirmedTitle: "Dziękujemy, wszystko gotowe!",
  confirmedBody: "Portret idzie do druku i wkrótce zostanie wysłany. Dostaniesz maila, gdy tylko ruszy w drogę.",
 ...
 sv: {
  ...
  description: "Titta noga på bilden nedan innan vi skickar porträttet till tryck.",
  confirmButton: "Jag godkänner, tryck och skicka",
  changesButton: "Jag vill ändra något",
  confirmedTitle: "Tack, allt är klart!",
  confirmedBody: "Porträttet går till tryck och skickas snart. Du får ett mejl så fort det är på väg.",
 ...
 da: {
  ...
  description: "Kig grundigt på billedet herunder, før vi sender portrættet til tryk.",
  confirmButton: "Jeg godkender, tryk og send",
  changesButton: "Jeg vil ændre noget",
  confirmedTitle: "Tak, alt er klar!",
  confirmedBody: "Portrættet går i tryk og bliver sendt snart. Du får en mail, så snart det er på vej.",
 ...
 pt: {
  ...
  description: "Vê a imagem com atenção antes de mandarmos o retrato para impressão.",
  confirmButton: "Confirmo, imprimam e enviem",
  changesButton: "Quero uma alteração",
  confirmedTitle: "Obrigado, está tudo tratado!",
  confirmedBody: "O retrato vai para impressão e segue em breve. Recebes um email assim que estiver a caminho.",
...
export const welcomeSequence: Record<Lang, [WelcomeStep, WelcomeStep, WelcomeStep]>= {
 ...
 paragraphs: [
 "Cartoonova, c'est simple: vous envoyez une photo, elle devient un portrait dans le style de votre choix — Simpson, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty ou Disney.",
 ...
 "Ce qui complique le travail: les photos floues, très sombres, prises de loin, ou fortement filtrées. Pour un portrait de groupe, mieux vaut plusieurs photos individuelles nettes qu'une seule photo de groupe lointaine — on les réunit ensuite.",
 ...
 paragraphs: [
 "Cartoonova is simple: you send a photo, it becomes a portrait in the style you pick — Simpsons, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty or Disney.",
 ...
 "What makes it harder: blurry, very dark, distant or heavily filtered photos. For a group portrait, several sharp individual photos beat one distant group shot — we bring them together afterwards.",
 ...
 paragraphs: [
 "Cartoonova es sencillo: envías una foto y se convierte en un retrato en el estilo que elijas — Simpson, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty o Disney.",
 ...
 "Lo que complica el trabajo: fotos borrosas, muy oscuras, tomadas de lejos o con muchos filtros. Para un retrato de grupo, mejor varias fotos individuales nítidas que una foto de grupo lejana — las reunimos después.",
 ...
 paragraphs: [
 "Cartoonova ist einfach: Sie schicken ein Foto, daraus wird ein Porträt — im Stil Ihrer Wahl: Simpsons, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty oder Disney.",
 ...
 "Was die Arbeit erschwert: unscharfe, sehr dunkle, weit entfernte oder stark gefilterte Fotos. Für ein Gruppenportrait sind mehrere scharfe Einzelfotos besser als eine entfernte Gruppenaufnahme — wir fügen sie zusammen.",
 ...
 paragraphs: [
 "Cartoonova è semplice: mandi una foto e diventa un ritratto nello stile che scegli — Simpson, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty o Disney.",
 ...
 "Cosa complica il lavoro: foto sfocate, molto scure, scattate da lontano o molto filtrate. Per un ritratto di gruppo, meglio più foto individuali nitide che una sola foto di gruppo lontana — le uniamo dopo.",
 ...
 nl: [
  ...
  paragraphs: [
  "Cartoonova is eenvoudig: jij stuurt een foto en die wordt een portret in de stijl die jij kiest — Simpsons, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty of Disney.",
  ...
  "Wat het lastiger maakt: wazige, erg donkere, veraf genomen of zwaar gefilterde foto's. Voor een groepsportret zijn losse scherpe foto's beter dan één groepsfoto van veraf — we zetten ze daarna samen.",
 ...
 pl: [
  ...
  paragraphs: [
  "Cartoonova to proste: ty przysyłasz zdjęcie, a ono staje się portretem w wybranym stylu — Simpsonowie, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty albo Disney.",
  ...
  "Co utrudnia: zdjęcia rozmyte, bardzo ciemne, robione z daleka albo mocno przefiltrowane. Przy portrecie grupowym kilka ostrych zdjęć pojedynczych osób daje lepszy efekt niż jedno zdjęcie grupowe z daleka — złożymy je później.",
 ...
 sv: [
  ...
  paragraphs: [
  "Cartoonova är enkelt: du skickar ett foto och det blir ett porträtt i den stil du väljer — Simpsons, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty eller Disney.",
  ...
  "Det som gör det svårare: suddiga, väldigt mörka, avlägsna eller kraftigt filtrerade foton. Till ett gruppporträtt slår flera skarpa enskilda foton ett gruppfoto på avstånd — vi för samman dem efteråt.",
 ...
 da: [
  ...
  paragraphs: [
  "Cartoonova er enkelt: du sender et foto, og det bliver til et portræt i den stil, du vælger — Simpsons, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty eller Disney.",
  ...
  "Det der gør det sværere: slørede, meget mørke, fjerne eller kraftigt filtrerede fotos. Til et gruppeportræt slår flere skarpe enkeltfotos ét gruppefoto på afstand — vi samler dem bagefter.",
 ...
 pt: [
  ...
  paragraphs: [
  "A Cartoonova é simples: tu envias uma foto e ela torna-se um retrato no estilo que escolheres — Simpsons, One Piece, Dragon Ball, Ghibli, Rick &amp; Morty ou Disney.",
  ...
  "O que dificulta: fotos desfocadas, muito escuras, tiradas de longe ou com filtros pesados. Para um retrato de grupo, várias fotos individuais nítidas valem mais do que uma foto de grupo ao longe — juntamo-las depois.",
...
export const abandonedCartEmail: Record<Lang, {
  ...
  fr: {
    ...
    kept: "Vos photos sont bien conservées : il ne reste qu’à finaliser pour qu’on s’y mette.",
  ...
  en: {
    ...
    kept: "Your photos are safely stored: just finish the order and we'll get started.",
    cta: "Finish my order",
  ...
  es: {
    ...
    kept: "Tus fotos están guardadas: solo falta finalizar para que nos pongamos manos a la obra.",
  ...
  de: {
    ...
    kept: "Ihre Fotos sind gespeichert: Sie müssen die Bestellung nur abschließen, dann legen wir los.",
  ...
  it: {
    ...
    kept: "Le tue foto sono al sicuro: basta completare l’ordine e ci mettiamo all’opera.",
 ...
 nl: {
  ...
  kept: "Je foto's staan veilig opgeslagen: maak de bestelling af en we gaan aan de slag.",
 ...
 pl: {
  ...
  kept: "Twoje zdjęcia są bezpiecznie zapisane: wystarczy dokończyć zamówienie, a zabierzemy się do pracy.",
 ...
 sv: {
  ...
  kept: "Dina foton ligger kvar tryggt: slutför beställningen så sätter vi i gång.",
 ...
 da: {
  ...
  kept: "Dine fotos ligger trygt gemt: gør bestillingen færdig, så går vi i gang.",
 ...
 pt: {
  ...
  kept: "As tuas fotos estão guardadas em segurança: basta terminares a encomenda e começamos.",
...
export const depotPhotosPage: Record<Lang, {
  ...
  fr: {
    ...
    description: (ref) => `Commande #${ref} — il ne manque que vos photos pour qu'on commence.`,
    ...
    doneBody: "On peut se mettre au travail. Vous recevrez votre portrait sous 2 jours ouvrés.",
  ...
  en: {
    ...
    doneBody: "We can get to work. You'll receive your portrait within 2 working days.",
  ...
  es: {
    ...
    description: (ref) => `Pedido #${ref} — solo faltan tus fotos para que empecemos.`,
    ...
    doneBody: "Ya podemos ponernos a trabajar. Recibirás tu retrato en 2 días laborables.",
  ...
  de: {
    ...
    description: (ref) => `Bestellung #${ref} — es fehlen nur noch Ihre Fotos, damit wir beginnen können.`,
    ...
    doneBody: "Wir können loslegen. Sie erhalten Ihr Porträt innerhalb von 2 Werktagen.",
  ...
  it: {
    ...
    description: (ref) => `Ordine #${ref} — mancano solo le tue foto per iniziare.`,
    ...
    doneBody: "Possiamo metterci al lavoro. Riceverai il ritratto entro 2 giorni lavorativi.",
  ...
  nl: {
    ...
    doneBody: "We kunnen aan de slag. U ontvangt uw portret binnen 2 werkdagen.",
  ...
  pl: {
    ...
    description: (ref) => `Zamówienie #${ref} — brakuje tylko Twoich zdjęć, abyśmy mogli zacząć.`,
    ...
    doneBody: "Możemy zabrać się do pracy. Portret otrzymasz w ciągu 2 dni roboczych.",
  ...
  sv: {
    ...
    description: (ref) => `Order #${ref} — bara dina foton saknas för att vi ska börja.`,
    ...
    doneBody: "Vi kan sätta igång. Du får ditt porträtt inom 2 arbetsdagar.",
  ...
  da: {
    ...
    description: (ref) => `Ordre #${ref} — der mangler kun dine fotos, før vi går i gang.`,
    ...
    doneBody: "Vi kan gå i gang. Du får dit portræt inden for 2 hverdage.",
  ...
  pt: {
    ...
    description: (ref) => `Encomenda #${ref} — só faltam as suas fotos para começarmos.`,
    ...
    doneBody: "Já podemos começar. Receberá o seu retrato em 2 dias úteis.",
