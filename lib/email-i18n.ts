...
export const confirmationEmail: Record<Lang, {
  ...
  fr: {
    ...
    deliveryTime: "Le dessin est réalisé en 24h. Si vous avez commandé une impression (poster, toile), comptez 3 à 5 jours ouvrés supplémentaires pour la fabrication et l'envoi.",
  ...
  en: {
    ...
    deliveryTime: "The artwork is completed within 24h. If you ordered a physical print (poster, canvas), add 3 to 5 business days for production and shipping.",
  ...
  es: {
    ...
    deliveryTime: "El dibujo se realiza en 24h. Si pediste una impresión física (póster, lienzo), añade 3 a 5 días laborables adicionales para la fabricación y el envío.",
  ...
  de: {
    ...
    deliveryTime: "Die Zeichnung wird innerhalb von 24 Std. fertiggestellt. Bei einem physischen Druck (Poster, Leinwand) kommen 3 bis 5 Werktage für Herstellung und Versand hinzu.",
  ...
  it: {
    ...
    deliveryTime: "Il disegno viene realizzato in 24h. Se hai ordinato una stampa fisica (poster, tela), aggiungi 3-5 giorni lavorativi in più per la produzione e la spedizione.",
