...
export default function ProductPage() {
  ...
  const prints = prices ? [
    { img: "/Disney/Add-Ons/digital.png", key: "digital", label: t("digital"), sub: tp("digitalSub"), addon: prices.digital, displayPrice: prices.digital + prices.base, badge: tp("fastestBadge") },
    { img: "/Disney/Add-Ons/poster.png", key: "posterSimple", label: t("posterOption"), sub: tp("posterSimpleSub"), addon: prices.posterSimple, displayPrice: prices.posterSimple + prices.base, badge: "" },
    { img: "/Disney/Add-Ons/portrait_sur_toile.png", key: "canvas", label: t("canvas"), sub: tp("canvasSub"), addon: prices.canvas, displayPrice: prices.canvas + prices.base, badge: tp("bestsellerBadge") },
    { img: "/Disney/Add-Ons/portrait_encadré.png", key: "framed", label: t("poster"), sub: tp("framedSub"), addon: prices.poster, displayPrice: prices.poster + prices.base, badge: "" },
  ] : [];
                  ...
                  <div className="relative w-full h-full">
                    {HERO_SLIDES.map((src, i) => (
                      <div key={i} className={`absolute inset-0 transition-opacity duration-700 ${i === activeHero ? "hero-pop opacity-100" : "opacity-0 pointer-events-none"}`}>
                        <Image src={src} alt="Portrait disney personnalisé" fill className="object-cover" priority={i === 0} sizes="(max-width: 768px) 92vw, 44vw" />
                      </div>
                    ))}
