...
export const FAQ_ITEMS = [
  ...
  { q: "Les personnes doivent-elles toutes être sur la même photo ?", a: "Pas du tout ! Envoyez-nous des photos individuelles, on réunira tout le monde sur une seule image." },
...
export const COPY = {
  ...
  heroSubtitle: "Transformez-vous en personnage cartoon, d'après votre photo. Le cadeau unique et personnalisé parfait !",
  ...
  noteForArtist: "Précisions pour votre portrait",
  optional: "optionnel",
