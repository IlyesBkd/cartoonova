    ...
    <main className="min-h-screen pt-20">
        ...
        <section className="bg-white py-16 sm:py-20 border-b-4 border-black">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="/simpson" className="inline-block bg-yellow-400 text-black font-black text-base uppercase px-10 py-5 rounded-full border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[3px] hover:translate-y-[3px] active:translate-y-1 active:shadow-none transition-all">
