...
export function generateMetadata(params: {
  ...
  return metadataPageLegale(params, "confidentialite", "/politique-de-confidentialite");
}
    ...
    <div className="section">
      ...
      <div>
        ...
        <section>
          ...
          <p>La présente Politique de Confidentialité décrit la manière dont nous collectons, utilisons, stockons et protégeons vos données personnelles lorsque vous utilisez notre site <strong>cartoonova.com</strong> (ci-après « le Site ») et nos services de création de caricatures personnalisées.</p>
          <p>Cette politique est conforme au Règlement Général sur la Protection des Données (RGPD — Règlement UE 2016/679) et à la loi « Informatique et Libertés » du 6 janvier 1978 modifiée.</p>
        </section>
        ...
        <section>
          ...
          <p>Tous nos prestataires sont soumis à des obligations contractuelles strictes de confidentialité et de protection des données conformes au RGPD.</p>
        </section>
        ...
        <section>
          ...
          <p>Vous pouvez gérer vos préférences de cookies à tout moment via les paramètres de votre navigateur ou via notre bandeau de consentement.</p>
        </section>
        ...
        <section>
          ...
          <p>Pour exercer l&apos;un de ces droits, contactez-nous à :{" "}
            <a href="mailto:support@cartoonova.com">support@cartoonova.com</a>
          </p>
          <p>Nous nous engageons à répondre à votre demande dans un délai de 30 jours. Vous disposez également du droit d&apos;introduire une réclamation auprès de la <strong>CNIL</strong> (Commission Nationale de l&apos;Informatique et des Libertés) : <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer">www.cnil.fr</a>.</p>
        </section>
