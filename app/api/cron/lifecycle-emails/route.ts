...
import { getLangFromCountry, reviewRequestEmail, reorderEmail } from "@/lib/email-i18n";
...
// l'impression soit arrivee (24h de dessin + 3-5j ouvres de fabrication/envoi).
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const result = { welcome, reviewRequests, reorders };
